...
public class RecordController {
	...
	// public List<StudentRecordEntity> getStudentRecordsByAdviser(@RequestParam
	// String sid,@RequestParam String section,@RequestParam String schoolYear){
	// return sserv.getStudentRecordsByAdviser(sid,section,schoolYear);
	// }

	// @PutMapping("/updateStudentReport")
	// public StudentReportEntity updateStudentReport(@RequestParam int
	// rid,@RequestBody StudentReportEntity newStudentReportDetails) {
	...
	@GetMapping("/getStudentRecordsByAdviser")
	public List<RecordEntity> getAllStudentRecordsByAdviser(@RequestParam int grade, @RequestParam String section,
			@RequestParam String schoolYear) {
		return recordService.getAllStudentRecordsByAdviser(grade, section, schoolYear);
	}

	@GetMapping("/getRecordsByAdviser")
	public List<RecordEntity> getAllRecordsByAdviser(@RequestParam int grade, @RequestParam String section,
			@RequestParam String schoolYear, @RequestParam Long userId) {
